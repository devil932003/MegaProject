...
const Home = () => {
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            ...
            <div ref={vehiclePanelRef} className='fixed w-full z-20 bottom-0 translate-y-[120%] bg-white px-3 py-10 pt-12'>
                <VehiclePanel
            ...
            <div ref={confirmRidePanelRef} className='fixed w-full z-20 bottom-0 translate-y-[120%] bg-white px-3 py-6 pt-12'>
                <ConfirmRide
            ...
            <div ref={vehicleFoundRef} className='fixed w-full z-20 bottom-0 translate-y-[120%] bg-white px-3 py-6 pt-12'>
                <LookingForDriver
                    createRide={createRide}
                    pickup={pickup}
                    destination={destination}
            ...
            <div ref={waitingForDriverRef} className='fixed w-full z-20 bottom-0 translate-y-[120%] bg-white px-3 py-6 pt-12'>
                <WaitingForDriver
                    ride={ride}
                    setVehicleFound={setVehicleFound}
